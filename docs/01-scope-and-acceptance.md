...
Owner：本文件拥有产品优先级和验收编号。**Phase 0 是本次文档阶段；P0 是后续产品 MVP 优先级，两者不同。** 以下产品项目均未实现。
...
照片引导采访（P0 类型支持 image）、更丰富河流动画、显式人物文风蒸馏、ASR 热词学习、高级出处查看器、带原件的 portable ZIP、完整离线交互 HTML。P0 无 persona 时仍能生成朴素第一人称自传。
