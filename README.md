...
**v0.2.0-rc.2 体验重构候选**：人物档案隔离、独立长河与自传阅读、原生设置、自由叙事与独立事实审校。**稀疏复杂自传技术门禁3/3通过，等待作者最终叙事审读，尚未创建v0.2.0 tag。** 当前验收见 [v0.2](docs/v0.2-redesign.md)。[v0.1.0课程发行](docs/release-v0.1.0.md)与tag保持不变；实体麦克风R2和真人采访恢复R3仍待作者验收。没有公开预构建镜像，使用本地Docker构建。
