...
**v0.2.0-rc.1 体验重构工作线**：人物档案隔离、独立长河与自传阅读、原生设置、自由叙事与独立事实审校。**尚未通过RC验收：复杂稀疏语料自传仍可能审校失败。** 当前验收见 [v0.2](docs/v0.2-redesign.md)。[v0.1.0课程发行](docs/release-v0.1.0.md)与tag保持不变；实体麦克风R2和真人采访恢复R3仍待作者验收。没有公开预构建镜像，使用本地Docker构建。
