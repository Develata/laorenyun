...
RUN mkdir -p /opt/dsh-laorenyun && tar -xzf /build/package/dsh-laorenyun-0.2.0-rc.5.tgz -C /opt/dsh-laorenyun --strip-components=1 && ln -s /app/data/dsh/profiles/node_modules /opt/dsh-laorenyun/node_modules
