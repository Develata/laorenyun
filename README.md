...
**当前状态：Phase 4 长河、纠正、人物表达、自传和离线导出已通过，见 [Phase 4](docs/phase-4.md)。Phase 2 实体麦克风及真人恢复仍待验收，见 [Phase 2](docs/phase-2.md)。** 本仓库是完整应用与 DeepSeek Harness 发行层；[dsh-laorenyun](https://github.com/Develata/dsh-laorenyun) 拥有业务插件。原创内容采用 [MIT](LICENSE)，第三方内容分别遵守[各自许可](THIRD_PARTY_NOTICES.md)。
